...
$( document ).ready(function() {
    ...
    setInterval(function () {
        ...
        if ($('#espresso_neu').html() < 2) {
            $('#espressoText_neu').html("Espresso")
        }
        else {
    ...
    $('form').submit(function (e) {
        ...
        var kantonsWahl = $('#auswahlKanton').val();
        ...
        switch (kantonsWahl) {
            ...
            case 'baselland':
                ...
                $('#erbeText').text("Erbschaften unter 10'000 Franken sind steuerfrei.");
            ...
            case 'baselstadt':
                ...
                $('#erbeText').text("Erbschaften unter 2'000 Franken sind steuerfrei.");
            ...
            //Schwyz
            case 'schwyz':
                $('#erbeText').text("Im Kanton Schwyz sind Erbschaften steuerfrei.");
